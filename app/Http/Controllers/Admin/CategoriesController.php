...
class CategoriesController extends Controller
{
    ...
    public function store(StoreCategory $request)
    {
        ...
        DB::statement('call sortCategories(?,?)', [$category->id,1]);
    ...
    public function itemup(Request $request, Category $category)
    {
        if($category->itemorder!=1){
            DB::statement('call sortCategories(?,?)', [$category->id, $category->itemorder-1]);
            /*
            $category->itemorder--;
            $category->update([
                'id'=> $category->id,
    ...
    public function itemdown(Request $request, Category $category)
    {
        if($category->itemorder<=65500){ //65535
            DB::select('call sortCategories(?,?)', [$category->id, $category->itemorder+1]);
            /*
            $category->itemorder++;
            $category->update([
                'id'=> $category->id,
