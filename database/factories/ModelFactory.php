...
/** @var  \Illuminate\Database\Eloquent\Factory $factory */
$factory->define(App\Models\Tab::class, static function (Faker\Generator $faker) {
    return [
...
$factory->define(App\Models\Application::class, static function (Faker\Generator $faker) {
    return [
        ...
        'isNewPage' => $faker->boolean(),
        'isNewPageForIframe' => $faker->boolean(),
